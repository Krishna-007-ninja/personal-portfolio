...
class ProjectDemo {
    constructor() {
        ...
        this.projectData = {
            ...
            description: 'The Leaf Disease Detection app is a machine learning-based solution designed to detect and classify common plant leaf diseases using image input. It assists farmers in identifying diseases early to improve crop protection and yield.'
        };
